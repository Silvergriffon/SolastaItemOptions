...
Reskin options: several appearance choices for Empress Garb, Crown Of The Magister invisible when worn.
Focus options: additional Druidic and Arcane foci, can make all magic Staves foci.
Merchant options: add all non-magical clothing to Gorim's store, re-stock all items in Faction stores.
Other options: Belt Of Dwarvenkind never or always grants beard, Sylvan Armor wearable by all.
